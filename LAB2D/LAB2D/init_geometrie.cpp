...
vec4 col_marrone = { .3,.3,0,1 };
vec4 col_grigio = { .5,.5,.5,1 };
vec4 col_bianco = { 1,1,1,1 };
vec4 col_rosso = { .9,0,0,1 };
vec4 col_beige = { .8,.8,0,1 };
vec4 col_verdastro = { .1,.3,.1,1 };
vec4 col_verde = { .15,.35,.15,1 };
vec4 col_nero = { 0,0,0,1 };
/*---------------------------------------*/
...
int vertices_Sbarra = 6;
Pointxy* Sbarra = new Pointxy[vertices_Sbarra];


//Particelle
int n_Particellari = 1000;
Pointxy* Particelle = new Pointxy[n_Particellari];
