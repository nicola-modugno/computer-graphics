...
GLuint ShaderMaker::createProgram(char* vertexfilename, char *fragmentfilename)
{
	...
	std::cout << "Caricamento vertex shader da: " << vertexfilename << std::endl;
	//Visualizzo sulla console il CODICE VERTEX SHADER
	//cout << VertexShader;
	if (VertexShader == NULL) {
		std::cerr << "Errore: impossibile leggere il file dello shader vertex: " << vertexfilename << std::endl;
		//return 0;
	}
	...
	std::cout << "Caricamento Fragment shader da: " << fragmentfilename << std::endl;
